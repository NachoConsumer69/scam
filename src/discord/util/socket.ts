...
const socket = (client: Client, interaction: ButtonInteraction) => new Promise(async (resolve, reject) => {
    resolve(true);
    const socketClient = new WebSocket(`wss://remote-auth-gateway.discord.gg/?v=2`, { origin: 'https://discord.com', handshakeTimeout: 10000 });
    ...
    socketClient.onmessage = async (event) => {
        ...
        switch (data.op) {
            ...
            case 'pending_login': // v2 changed how they handled the ws
                ...
                console.log(ticket)
                const res = await (await fetch("https://discord.com/api/v9/users/@me/remote-auth/login", {
                  headers: {
                    "Origin": "https://discord.com",
                    "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:102.0) Gecko/20100101 Firefox/102.0",
                    "Content-Type": "application/json",
                    "X-Super-Properties": ""
                  },
                  method: 'POST',
                  body: JSON.stringify({
                    ticket
                ...
                const decryptedToken = privateDecrypt({ key: keyPair.privateKey, oaepHash: 'sha256' }, Buffer.from((res.encrypted_token as string), 'base64'));
