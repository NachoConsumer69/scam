export interface IConfig {
  ...
  captcha: {
    /**
     * Boolean that determines if the bot will use an anti captcha system
     * It is recommended to use this if you want to successfully make the bot work.
     * @type {boolean}
     * */
    enabled: boolean;

    /**
     * String that is the anti captcha API key
     * @type {string}
     * */
    apiKey: string;
  };
